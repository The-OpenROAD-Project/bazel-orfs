...
load(
    ...
    _orfs_abstract = "orfs_abstract_rule",
    _orfs_arguments = "orfs_arguments",
    _orfs_cts = "orfs_cts_rule",
    _orfs_final = "orfs_final_rule",
    _orfs_floorplan = "orfs_floorplan_rule",
    _orfs_gds = "orfs_gds_rule",
    _orfs_generate_metadata = "orfs_generate_metadata_rule",
    _orfs_grt = "orfs_grt_rule",
    _orfs_macro = "orfs_macro",
    _orfs_pdk = "orfs_pdk",
    _orfs_place = "orfs_place_rule",
    _orfs_route = "orfs_route_rule",
    _orfs_run = "orfs_run",
