...
`define RV_ICCM_SADR 32'hf0090000
`define RV_ICCM_NUM_BANKS_8 
`define RV_ICCM_REGION 4'hf
...
`define RV_ICCM_EADR 32'hf009ffff
`define RV_ICCM_DATA_CELL ram_2048x39
`define RV_ICCM_OFFSET 10'h90000
`define RV_RESET_VEC 'hf0090000
...
`define RV_EXTERNAL_PROG 'hc0000000
