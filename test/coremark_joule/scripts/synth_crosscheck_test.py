...
class SynthCrosscheckTest(unittest.TestCase):
    def test_core_only_energy(self):
        ...
        r = synth_crosscheck.arm_row("grt", 1200, report(0.0206, 0.0119, 0.001, 0.0006, 0.0033), 407448)
        ...
        self.assertAlmostEqual(r["core_dyn_uj"] + r["core_leak_nj"] / 1e3, r["core_uj"], places=9)
    ...
    def test_render_lists_every_arm_and_published_row(self):
        rows = [synth_crosscheck.arm_row("a", 1200, report(0.02, 0.01, 0.001, 0.0005, 0.003), 1000)]
