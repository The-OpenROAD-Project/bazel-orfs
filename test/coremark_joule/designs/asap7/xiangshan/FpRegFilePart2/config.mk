# FpRegFilePart2: floating-point register file, part 2 of 4: 256 x 16, 14 read and 7 write ports. Lives in the Region_1, flat in the parent.
#
...
export DESIGN_NAME             = FpRegFilePart2
export DESIGN_NICKNAME         = xiangshan_FpRegFilePart2
include ../block.mk
