...
# load.tcl/open.tcl resolve the SDC by globbing RESULTS_DIR, so an ODB
# coming from another package has to be staged there first -- the same
# reason test/estimation_ladder/extract_from_src.tcl exists.
...
set stage_info [find_sdc_file $results_odb]
