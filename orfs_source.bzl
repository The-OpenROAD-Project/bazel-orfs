...
ORFS_PATCHES = [
    ...
    # 0081: structured_netlists.tcl skips a placed netlist's cells that
    ...
    # 0083: a placed netlist's cells are dont_touch as well as FIRM;
    ...
    Label("//patches:0083-orfs-structured-netlists-dont-touch.patch"),
]
